...
def evaluation(model_path='/home/llj/tensorflow_s2vt/e2e_models/'):
    ...
    with open('e2e_models/batch4_lr1e-6_test.txt', 'w') as f:
      for i in xrange(3000,42000,3000):
        model_path_last = model_path + '5batch_size4e2e_batch4_lr1e-6_train_withoutval.txt-'+str(i)
        saver.restore(sess, model_path_last)
